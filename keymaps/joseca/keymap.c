...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( 
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                      KC_SPC,                    KC_RALT, LT(2,KC_ESC),  KC_LEFT,  KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        TO(0), KC_HOME, KC_UP,   KC_END, _______, KC_P0, KC_P1, KC_P2, KC_P3,  KC_NUM, _______, _______, _______, _______,
        KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_P4, KC_P5, KC_P6, _______, _______, _______,          _______,
        _______,          KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_P7, KC_P8, KC_P9, _______, _______,  _______, _______, KC_PSCR,
        _______, _______, _______,                            _______,                   _______, _______, _______, QK_BOOT, _______
    ),
    [2] = LAYOUT(
        _______, KC_LPRN,   KC_RPRN,   KC_LCBR,   KC_RCBR,   KC_LT,   KC_GT,   _______,   _______,   _______,   _______,  _______,  _______,  KC_NO,
        ...
        _______, KC_RGUI, _______,                            _______,                             _______, KC_ESC, _______, _______, _______
    )
